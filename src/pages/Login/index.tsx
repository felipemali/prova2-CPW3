...
const Login = () => {
  ...
  const { setExp, setAuthTime, isSessionValid, setUserr } =
  ...
  return (
    <div className={globalStyles.container}>
      ...
      <button className={styles.googleCard} onClick={() => signInWithGoogle()}>
        <img src={google} alt="Google" />
        <span>Entrar com Google</span>
      </button>
      <button className={styles.githubCard} onClick={() => signInWithGithub()}>
